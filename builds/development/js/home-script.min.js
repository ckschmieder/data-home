...
//      }
//      });   
jQuery(".portfolio_slider").on("beforeChange",function(){console.log("beforeChange fired"),player.pauseVideo()}),jQuery(document).ready(function(a){a(".portfolio_slider").on("beforeChange",function(a,b,c,d){console.log(player.getPlayerState()),1==player.getPlayerState()&&player.pauseVideo()}),
// Slick Carousel Settings
a(".gallery-responsive").slick({dots:!1,arrows:!1,infinite:!0,autoplaySpeed:6e3,slidesToShow:1,slidesToScroll:1,accessibility:!0,autoplay:!0,draggable:!0,swipe:!0,pauseOnFocus:!0,focusOnSelect:!0,asNavFor:".gallery-responsive-nav"}),a(".gallery-responsive-nav").slick({slidesToShow:7,slidesToScroll:1,asNavFor:".gallery-responsive",dots:!1,centerMode:!1,focusOnSelect:!0,pauseOnFocus:!0,autoplay:!1,asNavFor:".gallery-responsive"})}),
//------------------------------------------
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
